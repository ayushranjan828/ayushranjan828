<h1 align="center">Hi, <img src="https://raw.githubusercontent.com/nixin72/nixin72/master/wave.gif" alt="Waving hand animated gif" height="45" width="45" /> I'm Ayush Ranjan!</h1>
<h3 align="center">Data Science & Generative AI Enthusiast | Full Stack Developer</h3>

<p align="center">
B.Tech CSE student (2026) specializing in Machine Learning, Generative AI, and Full Stack Development —
building ML pipelines, AI agents, LLM workflows, RAG architectures, and cloud-based solutions.
</p>
...
<a href="https://github.com/ayushranjan828" target="_blank">
  <img src="https://cdn-icons-png.flaticon.com/512/733/733553.png" width="32px" alt="GitHub" />
</a>
...
## 💫 About Me
- 👨‍💻 Working on **ML pipelines, AI Agents, LLM workflows, NLP, and RAG architectures**
- 🧠 Skilled in **Generative AI**: LLMs, Prompt Engineering, RAG, AI Agents, Vector Databases
- ⚙️ Backend development with **FastAPI, REST APIs, JWT Auth, Pydantic, Pytest**
- 📊 Experienced in **Data Analysis, Statistical Modeling, and Deriving Business Insights**
- ☁️ Comfortable with **Docker, Linux, CI/CD pipelines, and AWS**
- 🎯 Currently sharpening skills in Big Data tools and cloud-native backend development

## 🛠️ Technical Skills

**Languages:** Python, Java, C++, SQL, JavaScript, HTML, CSS

**Backend:** FastAPI, Spring Boot, REST API, JWT Authentication & Authorization, Pydantic, Pytest

**Data Science & ML:** Data Analysis, Statistical Modeling, Machine Learning, Deep Learning, NLP, Computer Vision

**Generative AI:** LLMs, Prompt Engineering, Retrieval-Augmented Generation (RAG), AI Agents, Vector Databases

**Libraries & Frameworks:** NumPy, Pandas, Matplotlib, Seaborn, Scikit-learn, TensorFlow, LangChain, Hugging Face

**Big Data:** Hadoop, Hive, Pig

**Tools & DevOps:** Excel, Tableau, Git/GitHub, Docker, Linux, AWS, CI/CD Pipelines
...
<p>
  ...
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/hadoop/hadoop-original.svg" height="40" alt="Hadoop"/>
  <img src="https://www.vectorlogo.zone/logos/apache_hive/apache_hive-icon.svg" height="40" alt="Hive"/>
  <img src="https://www.vectorlogo.zone/logos/apache/apache-icon.svg" height="40" alt="Pig (Apache)"/>
